...
import {spacingMods, nodeMods, flexMods} from './modifiers'
import getModifiers from './getModifiers'
import getFlexModifiers from './getFlexModifiers'


class Row extends React.Component {
  static displayName = 'grid__row'
  ...
  get className () {
    const modifiers = concat(getModifiers(nodeMods, this.props),
  ...
  get renderProps () {
    const props = removeDefaultProps(Row.defaultProps, this.props)
